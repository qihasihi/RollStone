package com.school.util.ueditor;
...
public class Uploader {
    ...
    public static final String ENCODEING ="UTF-8";// "" ;System.getProperties().getProperty("file.encoding")
    ...
    private String getFolderMd5(){
        return MD5_NEW.getMD5Result(this.dataid);
    }
    /**
