...
DROP PROCEDURE IF EXISTS `j_user_columnright_info_proc_split`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `j_user_columnright_info_proc_split`(
...
BEGIN
	...
	DECLARE tmp_tbl_name VARCHAR(2000) DEFAULT 'j_user_columnright_info u'; 
