...
DROP PROCEDURE IF EXISTS `class_proc_search_split`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `class_proc_search_split`(
				         p_class_id INT,
...
BEGIN
	...
	DECLARE tmp_tbl_name VARCHAR(50) DEFAULT 'class_info u'; 
