...
DROP PROCEDURE IF EXISTS `j_columnright_pageright_info_proc_add`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `j_columnright_pageright_info_proc_add`(
...
BEGIN
	...
	SET affect_row = 0;
	SET tmp_sql="INSERT INTO j_columnright_pageright_info (";
