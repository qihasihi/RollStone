...
BEGIN
 ...
 SELECT SUM(
       CASE t.user_type 
      WHEN 0 THEN (SELECT COUNT(*) FROM j_class_user cu,user_info u WHERE u.ref=cu.user_id and u.state_id=0 and cu.relation_type=''学生'' and cu.class_id=t.user_type_id )
