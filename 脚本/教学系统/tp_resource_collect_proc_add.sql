...
DROP PROCEDURE IF EXISTS `tp_resource_collect_proc_add`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `tp_resource_collect_proc_add`(
...
BEGIN
	...
	SET affect_row = 0;
	SET tmp_sql="INSERT INTO tp_resource_collect (";
