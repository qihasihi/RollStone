...
BEGIN
	...
	DECLARE tmp_search_column VARCHAR(2000) DEFAULT ' u.*,v.version_name,v.abbreviation ';  
	...
	IF p_grade_name IS NOT NULL THEN
		SET tmp_sql=CONCAT(tmp_sql," where g.grade_value like '%",p_grade_name,"%'");
	END IF;	
