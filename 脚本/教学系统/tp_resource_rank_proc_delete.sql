...
DROP PROCEDURE IF EXISTS `tp_resource_rank_proc_delete`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `tp_resource_rank_proc_delete`(
				            p_ref INT,
...
BEGIN
	...
	SET affect_row = 0;
	SET tmp_sql="delete from tp_resource_rank where 1=1";
