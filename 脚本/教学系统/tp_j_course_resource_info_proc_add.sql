...
DROP PROCEDURE IF EXISTS `tp_j_course_resource_info_proc_add`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `tp_j_course_resource_info_proc_add`(
								p_ref BIGINT,
								p_res_id BIGINT,
								p_course_id BIGINT,
								p_resource_type int,
...
BEGIN
	...
	SET affect_row = 0;
	SET tmp_sql="INSERT INTO tp_j_course_resource_info (";
