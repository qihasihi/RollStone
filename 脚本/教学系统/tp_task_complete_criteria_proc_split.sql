...
DROP PROCEDURE IF EXISTS `tp_task_complete_criteria_proc_split`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `tp_task_complete_criteria_proc_split`(
				          p_ref INT,
...
BEGIN
	...
	DECLARE tmp_tbl_name VARCHAR(2000) DEFAULT 'tp_task_complete_criteria u'; 
