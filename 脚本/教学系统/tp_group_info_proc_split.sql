...
BEGIN
	...
	DECLARE tmp_tbl_name VARCHAR(2000) DEFAULT 'tp_group_info u LEFT JOIN j_class_user cu ON u.CLASS_ID=cu.CLASS_ID AND cu.RELATION_TYPE=''任课老师'' AND u.CLASS_TYPE=1 '; 
