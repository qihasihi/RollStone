...
DROP PROCEDURE IF EXISTS `rs_download_info_proc_split`$$

CREATE DEFINER=`schu`@`%` PROCEDURE `rs_download_info_proc_split`(
				          p_res_id BIGINT,
...
BEGIN
	...
	DECLARE tmp_tbl_name VARCHAR(2000) DEFAULT 'rs_download_info u'; 
