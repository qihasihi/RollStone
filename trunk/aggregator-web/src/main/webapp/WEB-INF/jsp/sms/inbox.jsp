...
<script type="text/javascript">
		...
		$(function(){
			//翻页控件
					p1=new PageControl({
						post_url:'sms?m=ajaxGetReceiveList',
						...
						http_free_operate_handler:beforajaxGetReceiveList,
						http_operate_handler:afterajaxGetReceiveList,	//执行成功后返回方法
...
<div class="jxpt_layout">
  ...
  <p class="p_l_35">
      <input type="checkbox" name="checkbox3" id="checkbox3" onclick="selAllCkObj(this)"/>全选&nbsp;&nbsp;&nbsp;
      <a href="javascript:pageGo('p1')" class="an_blue_small">刷新</a>
      <a href="javascript:doDelReceiveSMS();" class="an_blue_small">删除</a></p>
