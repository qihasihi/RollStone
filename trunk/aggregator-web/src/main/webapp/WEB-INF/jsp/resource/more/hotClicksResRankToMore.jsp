...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            p1=new PageControl({
                post_url:'resource?m=ajx_hotClicksRes&type=${param.type}',
                page_id:'page1',
            ...
            if(rps!=null&&rps.presult.list.length>0){
                $.each(rps.objList,function(idx,itm){
                    ...
                    html+=itm.subjectname+","+itm.gradename+","+itm.restypename+","+itm.filetypename
                            ...
                            +"<span class='ico46' title='浏览'></span><b class='font-red'>"+itm.currentClicks+"</b>"
...
<div class="subpage_head"><span class="ico57"></span><strong>
    <c:if test="${param.type=='week'}">
        最热资源排行榜——按周浏览量排行
    </c:if>
    <c:if test="${param.type=='month'}">
        最热资源排行榜——按月浏览量排行
    </c:if>
    </strong></div>
<div class="content1">
