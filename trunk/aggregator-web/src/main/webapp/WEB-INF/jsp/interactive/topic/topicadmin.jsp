...
<body>
<div class="subpage_head"><span class="ico55"></span><strong>新建论题</strong></div>
<div class="content1">
  <table border="0" cellpadding="0" cellspacing="0" class="public_tab1 public_input">
    ...
    <tr>
      <th>&nbsp;</th>
      <td>
      <a href="javascript:;" onclick="operateTopic()" class="an_small">提&nbsp;交</a><a href="javascirpt:;" onclick="window.close();" class="an_small">取&nbsp;消</a></td>
    </tr>
  </table>
  <br>
</div>
