/**
* 如果你希望本插件能得到更好的发展        请点击页面最下方的 google广告 :) 拜托了！
* 如果你希望能即时得到最新版本及更新信息  请留下你的email
* 欢迎访问 www.luocheng.cn 
* email:luo.cheng@163.com  QQ：5456588
* 2009.04.03 
*/
...
initialize:function (config){
        ...
        //width：宽度
        //height：高度
        this.config=Object.extend({contentType:1,isHaveTitle:true,scrollType:'no',isBackgroundCanClick:false,isSupportDraging:false,isShowShadow:true,isReloadOnClose:true,width:400,height:300},config||{});
        ...
        //overlay       ：
        //coverOpacity ：蒙布的透明值
        this.info={shadowWidth:4,title:"",contentUrl:"",contentHtml:"",callBack:null,parameter:null,confirmCon:"",alertCon:"",someHiddenTag:"select,object,embed",someHiddenEle:"",overlay:0,coverOpacity:80};
...
build:function(){
	...
	//设置窗口标题栏
	if(this.config.isHaveTitle){
		mainBox+='<tr height="24" bgcolor="'+this.color.tColor+'"><td><table style="-moz-user-select:none;height:24px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr>'+'<td width="6" height="24"></td><td id="dialogBoxTitle" style="color:'+this.color.wColor+';font-size:14px;font-weight:bold;">'+this.info.title+'&nbsp;</td>'+'<td id="dialogClose" width="20" align="right" valign="middle"></td><td width="6"></td></tr></table></td></tr>'
		}else{
			mainBox+='<tr height="10"><td align="right"></td></tr>'};
