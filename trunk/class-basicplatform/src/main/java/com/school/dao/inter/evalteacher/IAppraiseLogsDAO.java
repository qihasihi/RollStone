...
public interface IAppraiseLogsDAO<AppraiseLogsInfo> extends ICommonDAO<AppraiseLogsInfo> {
	...
	public List<Map<String,Object>> getQueryBanStatice(int year,
			String grade,String subjects,PageResult presult);
	...
	public List  getQueryTeacherStatice(BigDecimal flag,
			...
			BigDecimal isteares, BigDecimal ispreparelessons,
			BigDecimal isnoconflag, BigDecimal targetuserid);
