...
<body>
<form action="../imapi1_1?m=deleteTask" method="post">
    <table>
        <tr>
            <td>任务id</td>
        ...
        <tr>
            <td>sign:</td>
            <td><input type="text" name="sign" id="txt_a_sign" value=""/> <input type="button" value="生成" onclick="genderSign('deleteTask')"/></td>
        </tr>
        <tr>
            <td colspan="2">
