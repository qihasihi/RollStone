...
<div id="add" style="display:none" align="center">
    ...
    <form action="../imapi1_1?m=AddCourseRecord" target="ifm_result" method="post">
...
<div id="del"  style="display:none"  align="center">
    <%--//获取参数--%>
    <%--String jid=paramMap.get("jid");--%>
    <%--String schoolId=paramMap.get("schoolId");--%>
    <%--String classId=paramMap.get("classId");--%>
    ...
    <%--String sign=paramMap.get("sign");--%>
        ...
        <form action="../imapi1_1?m=DeleteRecord"  target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>DeleteRecord</h3></td>
                </tr>
                <tr>
                    <td style="width:150px">JID:</td>
                    <td><input type="text" name="jid" id="txt_d_jid" value="1843365"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>schoolId:</td>
                    <td><input type="text" name="schoolId" id="txt_d_schoolId" value="50002"/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>classId:</td>
                    <td><input type="text" name="classId" id="txt_d_classId" value="1"/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>recordId:</td>
                    <td><input type="text" name="recordId" id="txt_d_recordId" value=""/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>time:</td>
                    <td><input type="text" name="time" id="txt_d_time" value=""/></td>
                    <td><input type="button" value="当前时间" onclick="txt_d_time.value=new Date().getTime()+'';"/>
                        <span style="color:red;font-size:12px;">提示：三分钟内有效!</span></td>
                </tr>
                <tr>
                    <td>sign:</td>
                    <td><input type="text" name="sign" id="txt_d_sign" value=""/></td>
                    <td><input type="button" value="生成" onclick="genderSign('DeleteRecord','d')"/>
                    </td>
                </tr>
                <tr>
...
<div id="select"  align="center">
    ...
    <%--String sign=paramMap.get("sign");--%>
        ...
        <form action="../imapi1_1?m=GetClassRecord"  target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
