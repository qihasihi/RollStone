...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={subjectId:subjectId,time:time,classId:classId,schoolId:schoolId,jid:jid,userType:userType};
        ...
        <form action="../imapi1_1?getClassStatics"  target="ifm_result" method="post">
            <table style="width:650px;">
               <!-- <tr>
                ...
                <tr>
                    <td>classId:</td>
                    <td><input type="text" name="classId" id="txt_classId" value="16"/></td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassStatics')"/>
