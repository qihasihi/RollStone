...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var jid=$("#jid").val();
            var couresId = $("#courseId").val();
            var time=$("#txt_a_time").val();
            var param={schoolId:schoolId,taskId:taskid,jid:jid,time:time,courseId:couresId};
...
<body>
<form action="../imapi1_1?m=getLiveAddress" method="post">
    <table>
        <tr>
            <td>任务id</td>
        ...
        <tr>
            <td>专题id</td>
            <td><input type="text" name="courseId" id="courseId" value=""/> </td>
        </tr>
        ...
        <tr>
            <td>sign:</td>
            <td><input type="text" name="sign" id="txt_a_sign" value=""/> <input type="button" value="生成" onclick="genderSign('getLiveAddress')"/></td>
        </tr>
        <tr>
            <td colspan="2">
