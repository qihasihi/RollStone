...
<div id="dv_xuanxiang">
    <div id="add"  align="center">
        ...
        <form action="../../im1.1.3?m=searchClass.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td>schoolId:</td>
                    <td><input type="text" name="schoolId" id="txt_schoolId" value=""/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>classCode:</td>
                    <td>
                        <input type="text" name="classCode" id="txt_classCode" value=""/>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('searchClass.do')"/>
                    </td>
                </tr>
                <tr>
