...
<div id="dv_xuanxiang">
    <div id="dv_stu"  align="center">
        ...
        <form action="../../im1.1.3?m=updateTeacherClassSubject.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>updateTeacherClassSubject.do</h3>
                        <br/>
                ...
                <tr>
                    ...
                    <td><input type="text" name="targetJid" id="txt_targetJid" value="2470542"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>schoolId:</td>
                ...
                <tr>
                    <td>classId:</td>
                    <td><input type="text" name="classId" id="txt_classId" value="34445"/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>subjectId:</td>
                    <td><input type="text" name="subjectId" id="txt_subjectId" value="1,2,3"/></td>
                    <td>学科
                        1语文 2数学
                        3英语 4物理
                        5化学 6历史
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('updateTeacherClassSubject.do')"/>
                    </td>
                </tr>
                <tr>
