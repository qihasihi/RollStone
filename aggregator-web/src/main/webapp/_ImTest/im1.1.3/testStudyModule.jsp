...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var lastAccessTime = $("#txt_lastAccessTime").val();
...
<div id="dv_xuanxiang">
    ...
    <div id="select"  align="center">
        ...
        <form action="../../im1.1.3?m=StudyModule"  target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                     <td colspan="3" align="center"><h3>StudyModule</h3></td>
                 </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="lastAccessTime" id="txt_lastAccessTime" value="2010-10-10"/></td>
                    <td>&nbsp;</td>
                </tr>
