...
<div id="dv_xuanxiang">
    <div id="add"  align="center">
        <%--//获取参数--%>
            ...
            <%
                String totalUrl=UtilTool.utilproperty.get("TOTAL_SCHOOL_LOCATION").toString();
                totalUrl+="franchisedSchool?m=schoolList.do";
            %>
        <form action="<%=totalUrl%>" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>schoolList.do</h3>
                        <br/>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('schoolList.do')"/>
                    </td>
                </tr>
                <tr>
