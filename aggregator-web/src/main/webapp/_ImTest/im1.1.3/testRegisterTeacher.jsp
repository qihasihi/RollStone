...
<div id="dv_xuanxiang">
    <div id="add"  align="center">
        ...
        <form action="../../im1.1.3?m=teacherRegister.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>teacherRegister.do</h3>
                        <br/>
                ...
                <tr>
                    <td>schoolName:</td>
                    <td><input type="text" name="schoolName" id="txt_schoolName" value=""/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('teacherRegister.do')"/>
                    </td>
                </tr>
                <tr>
