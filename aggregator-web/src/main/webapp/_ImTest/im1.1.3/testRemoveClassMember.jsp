...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var targetJid=$("#txt_targetJid").val();
            var noJoin=$("#txt_noJoin").val();
...
<div id="dv_xuanxiang">
    <div id="dv_stu"  align="center">
        ...
        <form action="../../im1.1.3?m=removeClassMember.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>removeClassMember.do</h3>
                        <br/>
                ...
                <tr>
                    <td style="width:150px">targetJid:</td>
                    <td><input type="text" name="targetJid" id="txt_targetJid" value="2470492"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width:150px">noJoin:</td>
                    <td><input type="text" name="noJoin" id="txt_noJoin" value="0"/></td>
                    <td style="width:250px">是否允许再次加入  0:允许  1：不允许</td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('removeClassMember.do')"/>
                    </td>
                </tr>
                <tr>
