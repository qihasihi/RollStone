...
<div id="dv_xuanxiang">
    <div id="add"  align="center">
        ...
        <form action="../../im1.1.3?m=saveClassTimePoint.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>searchClass.do</h3>
                        <br/>
                ...
                <tr>
                    ...
                    <td><input type="text" name="jid" id="txt_jid" value="2470760"/></td>
                ...
                <tr>
                    <td>classId:</td>
                    <td>
                        <input type="text" name="classId" id="txt_classId" value="642322"/>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('saveClassTimePoint.do')"/>
                    </td>
                </tr>
                <tr>
