...
<div id="dv_xuanxiang">
    <div id="add"  align="center">
        ...
        <form action="../../im1.1.3?m=manageClassList.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>manageClassList.do</h3>
                        <br/>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('manageClassList.do')"/>
                    </td>
                </tr>
                <tr>
