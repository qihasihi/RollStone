...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={schoolId:schoolId,jid:jid,classId:classId,isVirtual:isvir,time:time,userType:userType,classType:classType};
...
<body>
<form action="../imapi1_1?m=ClassTask" method="post">
    <table>
        <tr>
            <td>班级id</td>
        ...
        <tr>
            <td>sign:</td>
            <td><input type="text" name="sign" id="txt_a_sign" value=""/> <input type="button" value="生成" onclick="genderSign('ClassTask')"/></td>
        </tr>
        <tr>
            <td colspan="2">
