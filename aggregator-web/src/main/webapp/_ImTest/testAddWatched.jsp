...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={schoolId:schoolId,jid:jid,time:time,taskId:taskId};
...
<body>
<form action="../imapi1_1?m=AddVideoWatched" method="post">
    <table>
        <tr>
            <td>任务id</td>
        ...
        <tr>
            <td>sign:</td>
            <td><input type="text" name="sign" id="txt_a_sign" value=""/> <input type="button" value="生成" onclick="genderSign('AddVideoWatched')"/></td>
        </tr>
        <tr>
            <td colspan="2">
