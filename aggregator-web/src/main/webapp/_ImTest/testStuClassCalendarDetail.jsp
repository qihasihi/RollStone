...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            var requestDay=$("#txt_requestDay").val();
            var schoolId=$("#txt_schoolId").val();
            var jid=$("#txt_jid").val();
            var userType=$("#txt_userType").val();
            var classId=$("#txt_classId").val();
            var time=$("#txt_time").val();
            var param={classId:classId,requestDay:requestDay,time:time,schoolId:schoolId,jid:jid,userType:userType};
...
<div id="select"  align="center">
    ...
    <%--String sign=paramMap.get("sign");--%>
        ...
        <form action="../imapi1_1?m=StuClassCalendarDetail"  target="ifm_result" method="post">
            <table style="width:650px;">
               <!-- <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('StuClassCalendarDetail')"/>
