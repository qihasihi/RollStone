...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={schoolId:schoolId,jid:jid,time:time,courseId:courseId,courseName:courseName,gradeId:gradeId,subjectId:subjectId};
...
<div id="dv_daohao" align="center">
    <a class="selected" data-bind="select">测试修改专题</a>
</div>
<div id="dv_xuanxiang">
    ...
    <div id="select"  align="center">
        ...
        <form action="../../im1.1.5?m=updateCourse"  target="ifm_result" method="post">
            <table style="width:650px;">
                 <tr>
                     <td colspan="3" align="center"><h3>http://192.168.8.238/sz_school/im1.1.5?m=updateCourse</h3></td>
                 </tr>
                <tr>
                    <td>courseId:</td>
                    <td><input type="text" name="courseId" id="txt_courseId" value=""/></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>courseName:</td>
                ...
                <tr>
                    ...
                    <td><textarea  name="classArray" id="txt_classArray">
                        [
                        {"classId":689194,"startTime":"2015-01-04 00:00:00","endTime":"2015-01-31 00:00:00"},
                        {"classId":323911,"startTime":"2015-01-05 00:00:00","endTime":"2015-01-31 00:00:00"},
                        {"classId":752358,"startTime":"2015-01-06 00:00:00","endTime":"2015-01-31 00:00:00"}
                        ]
                    </textarea></td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('updateCourse')"/>
