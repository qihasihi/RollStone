...
<head>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={schoolId:schoolId,jid:jid,time:time,classId:classId};
...
<div id="dv_daohao" align="center">
    <a class="selected" data-bind="select">测试添加专题前置</a>
</div>
<div id="dv_xuanxiang">
    ...
    <div id="select"  align="center">
        ...
        <form action="../../im1.1.5?m=getCourseSubjectAndClass"  target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                     <td colspan="3" align="center"><h3>http://192.168.8.238/sz_school/im1.1.5?m=getCourseSubjectAndClass</h3></td>
                 </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getCourseSubjectAndClass')"/>
