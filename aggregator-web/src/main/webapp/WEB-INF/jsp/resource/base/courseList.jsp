        ...
        function afterAjaxList(rps){
            ...
            if(rps!=null&&rps.presult.list.length>0){
                $.each(rps.objList,function(idx,itm){
                    html+="<tr>";
                    html+="<td><p><a href='resource?m=courseResList&courseid="+ itm.courseid +"' target='_blank'>"+ itm.coursename +"</a></p></td>";
                    html+="<td colspan='2'><p>"+ itm.materialnames +"</p></td>";
                    html+="<td>"+ (itm.realname.length<1?"北京四中网校":itm.realname) +"</td>";
...
<div class="subpage_nav">
    <ul>
        ...
        <li class="crumb"><a href="resource?m=courseList">按知识点搜索</a></li>
    </ul>
</div>
