...
<script type="text/javascript" src="js/resource/new_resbase.js"></script>
	...
	$(function(){
		if(defaultSearchValue!=null&&defaultSearchValue.length>0)
...
<div class="subpage_nav">
    <ul>
        <li class="crumb"><a href="simpleRes?m=resList">按资源搜索</a></li>
        <li><a href="simpleRes?m=courseList">按知识点搜索</a></li>
    </ul>
</div>
...
<div class="content2">
    <div class="zyxt_searchT public_input">
        ...
        <a class="an_search" href="javascript:pageGo('p1',1);" title="搜索"></a>&nbsp;&nbsp;<a href="simpleRes?m=list" class=" font-darkblue" >高级搜索</a>
