        ...
        if(rps.objList!=null&&rps.objList.length>0){
            ...
            $.each(rps.objList,function(idx,itm){
                if(cufiletype==2){ //视频
                    ...
                    h+='<li><a href="simpleResm=todetail&resid='+itm.resid+'"><img src="'+imgpath+'" width="160" height="90" />'+itm.resname25word+'</a></li>'; //alt="'+itm.resname25word+'" title="'+itm.resname25word+'"
                }else if(cufiletype==4){    //图片
...
<c:if test="${fileType=='jpeg'}">
    ...
    <div class="zyxt_zyxqL">
        <img src="simpleRes?m=getResourceImage&resid=${resObj.resid}&w=578&h=480" alt="${resObj.resname}" id="img_show"/>
    </div>
</c:if>
