...
<script type="text/javascript">
		...
		$(function(){
			//翻页控件
					p1=new PageControl({
						post_url:'sms?m=ajaxGetSentList',
						new_page_html_mode:true,
						page_control_name:"p1",		//分页变量空间的对象名称
						post_form:document.pageform,		//form
						http_free_operate_handler:beforajaxGetSentList,
						gender_address_id:'pageaddress',		//显示的区域						
						http_operate_handler:afterajaxGetSentList,	//执行成功后返回方法
...
<div class="jxpt_layout">
  ...
  <p class="p_l_35">
      ...
      <a href="javascript:doDelSentSMS();" class="an_blue_small">删除</a></p>
