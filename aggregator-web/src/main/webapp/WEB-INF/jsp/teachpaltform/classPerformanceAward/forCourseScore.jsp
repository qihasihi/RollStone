...
<table border="0" cellpadding="0" cellspacing="0" class="public_tab2">
    ...
    <tr>
        ...
        <th>小组得分</th>
        <th>课程积分</th>
        <th>积分排行榜<a href="javascript:;" onclick="loadCourseScore(${param.subjectid},${param.classid},${param.termid},1)" class="ico48a"></a><a href="javascript:;" onclick="loadCourseScore(${param.subjectid},${param.classid},${param.termid},1)"  class="ico48b"></a></th>
    </tr>
    <c:if test="${!empty dataMapList}">
           <c:forEach items="${dataMapList}" var="dm" varStatus="dmIdx">
               <tr class="${dmIdx.index%2==0?"trbg1":""}">
                   <td><a href="javascript:void('${dm.USER_ID}');" target="_blank">${dm.STU_NAME}</a></td>
