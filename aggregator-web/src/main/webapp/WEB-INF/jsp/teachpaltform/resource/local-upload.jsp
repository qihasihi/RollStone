        ...
        <tr>
            ...
            <td><p class="font-black">
                ...
                <div class="jxxt_zhuanti_zy_add" id="p_res_file">
                    ...
                    <p class="font-gray">1. 附件限一个，<2G。 <br>2. 视频限MP4格式，建议使用<a class="font-darkblue" href="<%=basePath%>uploadfile/cqmygysdssjtwmydtsgx/20141119.zip">格式工厂</a>等软件转换，视频编码为：AVC（H264），比特率为：300-500KB/秒 </p>
                </div>
