        ...
        function afterAjaxList(rps){
            ...
            if(rps!=null&&rps.presult.list.length>0){
                $.each(rps.objList,function(idx,itm){
                    ...
                    html+="<a target='_blank' href='resource?m=todetail&resid="+itm.resid+"'>"+ itm.resname +"</a></p></td>";
...
<body>
<div class="subpage_head"><span class="lm_ico03"></span><strong>全部资源</strong></div>
<input type="hidden" id="subject" value="${!empty subjectid?subjectid:subjectEVList[0].subjectid}"/>
<input type="hidden" id="restype" value="${resTypeEVList[0].dictionaryvalue}"/>
<input type="hidden" id="orderby" value="ABS(${currentloginGrd}-IFNULL(tm.grade_id,0)) ASC,r.CLICKS DESC "/>
...
<div class="content">
    <div class="contentR zyxt_qbzy">
        <div class="subpage_lm">
            <ul>
                <li id="order_1" class="crumb"><a href="javascript:changeOrderBy('ABS(${currentloginGrd}-IFNULL(tm.grade_id,0)) ASC,r.CLICKS DESC',1);">按浏览量</a></li>
                <li id="order_2"><a href="javascript:changeOrderBy('ABS(${currentloginGrd}-IFNULL(tm.grade_id,0)) ASC,r.C_TIME DESC',2);">按发布时间</a></li>
                <li id="order_3"><a href="javascript:changeOrderBy('ABS(${currentloginGrd}-IFNULL(tm.grade_id,0)) ASC,r.RECOMENDNUM DESC',3);">按推荐次数</a></li>
            </ul>
