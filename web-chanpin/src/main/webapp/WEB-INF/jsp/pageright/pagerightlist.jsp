...
<div class="public_lable_layout">
    <ul class="public_lable_list">
      ...
      <li><a href="columnright?m=list">栏目权限管理</a></li>
      <li class="crumb"><a href="pageright?m=list">页面权限管理</a></li>
    </ul>
  </div>
...
<div class="p_20">
    ...
    栏目：<select name="sel_column_id" id="sel_column_id" >
      ...
      <input placeholder="权限名称/路径值 进行查询!" value="" id="sel_pagevalue"     	
       name="sel_pagevalue"  type="text" class="public_input w200" />
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="public_tab2 m_t_25">
      ...
      <colgroup span="1" class="w250"></colgroup>
...
<div class="public_windows_layout w395 h250" id="div_add" style="display:none;">
  ...
  <p class="t_c font14 font_strong p_t_10">新建路径权限</p>
  <table border="0" cellpadding="0" cellspacing="0" class="public_tab1 m_a_10">
    <col class="w80"/>
    <col class="w260"/>
    <tr>
      <td>权限名称：</td>
      <td><input name="add_page_name" id="add_page_name" type="text" class="public_input w200" /></td>
    </tr>
    <tr>
      <td>路 径 值：</td>
      <td><input name="add_page_value" id="add_page_value" type="text" class="public_input w200" /></td>
    </tr>
    <tr>
      <td>所属栏目： </td>
      <td>
    ...
    <tr>  
      <td>备注：</td>
      <td><textarea name="add_remark" style="height:30px;"  id="add_remark" class="public_input w200" ></textarea></td>
    </tr>  
  </table>
...
<div class="public_windows_layout w395 h250" id="div_upd" style="display:none;">
  ...
  <p class="t_c font14 font_strong p_t_10">编辑路径权限</p>
  <table border="0" cellpadding="0" cellspacing="0" class="public_tab1 m_a_10">
    <col class="w80"/>  
    <col class="w260"/>
    <tr>
      <td>权限名称：</td>
      <td><input name="update_page_name" id="update_page_name" type="text" class="public_input w200" /></td>
    </tr>
    <tr>
      <td>路 径 值：</td>
      <td><input name="update_page_value" id="update_page_value" type="text" class="public_input w200" /></td>
    </tr>
    <tr>
      <td>所属栏目： </td>
      <td><select id="update_columns_id" name="update_columns_id">
      		<c:if test="${!empty columnList}">
    		<c:forEach items="${columnList}" var="coltmp">
    			<option value="${coltmp. columnid}">${coltmp.columnname}<span style="color:gray">[${coltmp.path}]</span></option>
    		</c:forEach>
    ...
    <tr>
      <td>备注：</td>
      <td><textarea name="update_remark" style="height:30px;" id="update_remark" class="public_input w200" ></textarea></td>
    </tr>
  </table>
  <p class="p_t_10 t_c"><a class="an_gray"  href="javascript:doUpd();">修改</a></p>
</div>
