...
<%@include file="/util/common-jsp/common-hdxt.jsp"%>
  ...
  <tr>
    <th>名&nbsp;&nbsp;&nbsp;&nbsp;称：</th>
    <td><input name="atName"  maxlength="15"  id="atName" type="text" class="public_input w250" />&nbsp;&nbsp;<span  style="color: gray;">请限制在15字以内</span></td>
    </tr>
  <tr>
    <th valign="top">场&nbsp;&nbsp;&nbsp;&nbsp;地：</th>
    <td>
	    <span><a href="javascript:showSiteAddressModel('select_siteAddress',false)" class="an_blue_small">添&nbsp;加</a></span>
	    <div id="address_span"></div>
    </td>
    </tr>
  <tr>
    <th>开始时间：</th>
    <td><input onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})" readonly="readonly"   id="beginTime"  name="beginTime" type="text" class="public_input w250" /></td>
    </tr>
  <tr>
    <th>结束时间：</th>
    <td><input onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})" readonly="readonly"   id="endTime" id="endTime"  type="text" class="public_input w250" /></td>
    </tr>
    <tr>
    <th>会场需求：</th>
    <td> <textarea onkeyup="ckLength(this,300)" name="audiovisual" id="audiovisual" class="public_input h90 w450 m_t_5"></textarea>
    <br/><span style="color: gray" >例如：茶水，电教器材 等等!</span>
    </td>
    </tr>
  <tr>  
    <th>估计人数：</th>
    <td><input maxlength="5" onkeyup="this.value=this.value.replace(/\D/g,'')" name="estimationNum"  id="estimationNum" type="text" class="public_input w100" /></td>
    </tr>
  <tr>
    <th valign="top">参与人员：</th>
    <td> 
    <span id="addUser"><a href="javascript:add_addUser()" class="an_blue_small">添&nbsp;加</a></span> <span class="p_l_30"><input id="issign" name="issign"  onclick="issign_click(this)" type="checkbox" value="" /> 
      不选择人员</span>    
  ...
  <tr>
    <th>活动介绍：</th>
    <td><span class="Pt10">
      <textarea onkeyup="ckLength(this,1300)" name="content" id="content" class="public_input h90 w450 m_t_5"></textarea>
    </span>
     ...
     <tr>
      <th>&nbsp;</th>
      <td><a href="javascript:doAdd()"  class="an_blue">确&nbsp;定</a><a href="javascript:clearForm(document.addform)" class="an_blue">重&nbsp;置</a></td>
    </tr>
</table>
</form>
    </div>
