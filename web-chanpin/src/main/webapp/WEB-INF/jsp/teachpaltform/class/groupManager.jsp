...
//        });
    ...
    function abc(clsid,clstype){
        location.href="group?m=toGroupManager&classid="+clsid+"&classtype="+clstype+"&pageidx="+currtenTab;
    }
</script>
</head>
    <body>
    ...
    <div class="content">
        ...
        <div class="subpage_contentL">
            <ul>
                ...
                <li class="crumb"><a href="group?m=toGroupManager&classid=${classid}&classtype=${classtype}">小组管理</a></li>
