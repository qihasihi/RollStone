...
public class TpResourceController extends BaseController<TpCourseResource>{
     ...
     * @throws Exception
     */
    @RequestMapping(params="doUploadResourceFile",method=RequestMethod.POST)
    public void doUploadResourceFile(HttpServletRequest request,HttpServletResponse response)throws Exception{
        JsonEntity je = new JsonEntity();
        String resid=request.getParameter("resid");
        String restype=request.getParameter("restype");
        String crestype=request.getParameter("resourcetype");
